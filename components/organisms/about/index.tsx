  ...
  return (
    <StyledContainer>
      ...
      <Container>
        ...
        <AboutText>
          Hi I'm Gabriel, Front-end Developer based in Houston Texas. Passionate
          about education and technology, which leads me to be in constant
          learning and growth. I dedicated myself to create web applications and
          interfaces, give them functionality.
        </AboutText>
        <br />
        <AboutText>
          Programming and learn are one of the things I like the most. My
          interests are focused on technology, music, entertainment and problem
          solving.
