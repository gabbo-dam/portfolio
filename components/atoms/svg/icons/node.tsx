...
function SvgComponent(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      />
      <g clipPath="url(#prefix__a)" transform="translate(-78.306 -164.016)">
        <path
          fill="url(#prefix__b)"
          d="M331.363 246.793l-118.715-58.19-60.87 124.174L270.49 370.97zm0 0"
        />
      </g>
      <g clipPath="url(#prefix__c)" transform="translate(-78.306 -164.016)">
        <path
          fill="url(#prefix__d)"
          d="M144.07 264.004l83.825 113.453 110.86-81.906-83.83-113.45zm0 0"
        />
      </g>
      <g clipPath="url(#prefix__e)" transform="translate(-78.306 -164.016)">
        <path
          fill="url(#prefix__f)"
